...
export const Security = () => {
  ...
  // const { timeAutoLock } = useSelector((state: RootState) => state.mobileSettings); // isUseBiometric
  ...
  //   {
  //     text: 'Always Require', // i18n.settings.alwaysRequire,
  ...
  //   },
  //   {
  //     text: 'If left for 10 minutes', // i18n.settings.ifLeftFor10Minutes,
  ...
  //   },
  //   {
  //     text: 'Never', // i18n.settings.neverRequire,
  ...
  //     toast.show(
  //       'Warning: No Password Requires',
  //       // i18n.notificationMessage.warningNeverRequirePassword, 
