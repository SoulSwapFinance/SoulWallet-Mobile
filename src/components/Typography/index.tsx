...
export const Body1ItalicsProps = {
  fontWeight: '500',
  fontSize: 16,
  lineHeight: 24,
  fontStyle: 'italic',
...
export const Body2ItalicsProps = {
  fontWeight: '500',
  fontSize: 14,
  lineHeight: 20,
  fontStyle: 'italic',
...
export const getTypographyStyleProps = (style: TypographyStyle): FontProps => {
  const propsMap: Record<TypographyStyle, FontProps> = {
    ...
    'Body2Italics': Body2ItalicsProps,
...
export const Body1Italics: FC<FontProps> = ({ children, ...rest }) => (
  <NBText color="text-default" {...Body1ItalicsProps} {...rest}>
    {children}
  </NBText>
);

export const Body2Italics: FC<FontProps> = ({ children, ...rest }) => (
  <NBText color="text-default" {...Body2ItalicsProps} {...rest}>
    {children}
  </NBText>
);
