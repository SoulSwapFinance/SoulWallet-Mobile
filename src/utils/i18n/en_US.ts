export const en = {
  common: {
    ...
    removeFromFavorites: 'Remove Bookmark',
    addBookmark: 'Add Bookmark',
    searchAtDuckDuckGo: 'Search at DuckDuckGo',
    searchResult: 'Search result',
    seeAll: 'See All',
    historyEmptyListPlaceholder: 'History will appear here',
    favoritesEmptyListPlaceholder: 'Bookmarks will appear here',
    ...
    days: 'days',
    hours: 'hours',
    forgotPassword: 'Delete Account?',
    resetAccount: 'Reset',
    eraseAll: 'Confirm Delete',
  ...
  welcomeScreen: {
    welcomeBackTitle: 'Welcome Summoner',
    welcomeMessage: '',
    welcomeBackMessage: 'Enter your password to unlock wallet',
    createAccLabel: 'Create Wallet',
    createAccMessage: 'Generate New Wallet.',
    importAccLabel: 'Import Wallet',
    importAccMessage: 'Import Existing Wallet.',
    attachAccLabel: 'Hardware Wallet',
    attachAccMessage: 'Attach Hardware Device.',
    forgotAccount: 'Reset Account',
  },
  exportAccount: {
  ...
  placeholder: {
    password: 'Password',
    typeYourSoulwalletPassword: 'Type your SoulWallet password',
    accountName: 'Account Name',
  ...
  emptyScreen: {
    ...
    categoryItemEmpty: 'Category is empty.',
  ...
  message: {
    ...
    transactionDoneMessage: 'Transaction submitted. Track progress on your Transaction History page.',
  ...
  header: {
    ...
    connectSoulwallet: 'Connect SoulWallet',
  ...
  importNetwork: {
    ...
    decimal: 'Decimals',
    symbol: 'Symbol',
    priceId: 'Price ID (CoinGecko)',
    chainType: 'Chain Type',
    blockExplorer: 'Block Explorer',
    crowdloanUrl: 'Crowdloan URL (optional)',
  },
  transferNft: {
    send: 'Send',
  },
