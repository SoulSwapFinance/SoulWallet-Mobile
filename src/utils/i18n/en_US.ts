export const en = {
  common: {
    ...
    firstScreenMessagePart2: 'User Agreement and Privacy Policy',
    ...
    importAlreadyAccount: 'Import an existing wallet',
  ...
  welcomeScreen: {
    ...
    createAccLabel: 'Create New Wallet',
    createAccMessage: 'Create new wallet with SoulWallet.',
    importAccLabel: 'Import Wallet',
    importAccMessage: 'Import an existing account.',
    attachAccLabel: 'Connect Hardware Device',
    attachAccMessage: 'Attach device without private key.',
  ...
  importAccount: {
    ...
    importByMetaMaskPrivateKey: 'Import via private key',
  ...
  header: {
    ...
    connectWithSubwallet: 'Connect with SoulWallet',
  ...
  settings: {
    ...
    aboutSubwallet: 'About SoulWallet',
    pinCode: 'PIN code',
