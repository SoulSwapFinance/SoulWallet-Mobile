...
increment_version() {
  ...
  sed -i -e "s|$CURRENT_VERSION|$NEW_VERSION|g" ios/SoulWalletMobile.xcodeproj/project.pbxproj
  sed -i -e "s|$BUILD_NUMBER|$NEW_BUILD_NUMBER|g" ios/SoulWalletMobile.xcodeproj/project.pbxproj
  ...
  rm -f "$PACKAGE_JSON-e"
  rm -f ios/SoulWalletMobile.xcodeproj/project.pbxproj-e
