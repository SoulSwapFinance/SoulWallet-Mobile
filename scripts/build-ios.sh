...
xcodebuild -workspace ./SoulWalletMobile.xcworkspace -scheme SoulWalletMobile -sdk iphoneos -configuration Release -quiet -archivePath $PWD/dist/SubWallet.xcarchive clean archive
