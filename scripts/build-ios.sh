...
xcodebuild -workspace ./SoulWalletMobile.xcworkspace -scheme SoulWalletMobile-Production -sdk iphoneos -configuration Release -quiet -archivePath $PWD/dist/SoulWallet.xcarchive clean archive
